...
document.addEventListener('DOMContentLoaded', function () {
  fetch('https://emus181.alwaysdata.net/')  // Reemplaza con la URL de tu API
      ...
      .then(data => {
          ...
          data.forEach(product => {
              ...
              productArticle.innerHTML = `
                  <img src="${product.Imagen ? product.Imagen : './images/default-image.jpg'}" alt="${product.Descripcion}">
                  <p>${product.Descripcion}</p>
                  <a href="./vermas.html">VER MAS</a>
              `;
              catalogoContainer.appendChild(productArticle);
          });
      })
